...
public class LoanCalcViewController implements Initializable {
	...
	private void btnClearResultsKeyPress(KeyEvent event) {
		// TODO: Call the method to clear the results. See below.
		btnClearFields();
	}
	...
	private boolean ValidateData() {
		...
		if LoanAmount > 0 {
			...
			System.out.println("LoanAmount is not valid");
		}
		...
		if InterestRate >= 1 && InterestRate <= 30 {
			...
			System.out.println("InterestRate is not valid");
		}
		...
		if NbrOfYears > 0 {
			...
			System.out.println("NbrOfYears is not valid");
		}
		...
		if AdditionalPayment > 0 {
			...
			System.out.println("AdditionalPayment is not valid");
		}
		...
		if EscorwAmount>0 {
			...
			System.out.println("EscrowAmount is not valid.")
		}
		return true;
	}
